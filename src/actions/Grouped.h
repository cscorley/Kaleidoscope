...
class Grouped
{
   ...
   KT_AUTO_DEFINE_ACTION_INVENTORY_TMPL(Grouped<_ActionType>)
};
...
class Grouped<ReportAction_>
{
   ...
   KT_AUTO_DEFINE_ACTION_INVENTORY_TMPL(Grouped<ReportAction_>)
};
...
Grouped<Action_> group(const std::shared_ptr<Action_> &action,
...
///
template<typename..._MoreActions>
Grouped<ReportAction_> group(const std::shared_ptr<ReportAction_> &action,
                          _MoreActions...more_actions) {
