...
class Simulator {
   ...
   public:
      ...
      int getNumReportsInCycle() const { return n_typed_reports_in_cycle_[AnyTypeReportTypeId]; }
      int getNumOverallReports() const { return n_typed_overall_reports_[AnyTypeReportTypeId]; }
      
      int getNumBootKeyboardReportsInCycle() const { return n_typed_reports_in_cycle_[BootKeyboardReportTypeIdId]; }
      int getNumOverallBootKeyboardReports() const { return n_typed_overall_reports_[BootKeyboardReportTypeIdId]; }
      
      int getNumKeyboardReportsInCycle() const { return n_typed_reports_in_cycle_[KeyboardReportTypeId]; }
      int getNumOverallKeyboardReports() const { return n_typed_overall_reports_[KeyboardReportTypeId]; }
      
      int getNumMouseReportsInCycle() const { return n_typed_reports_in_cycle_[MouseReportTypeId]; }
      int getNumOverallMouseReports() const { return n_typed_overall_reports_[MouseReportTypeId]; }
      
      int getNumAbsoluteMouseReportsInCycle() const { return n_typed_reports_in_cycle_[AbsoluteMouseReportTypeId]; }
      int getNumOverallAbsoluteMouseReports() const { return n_typed_overall_reports_[AbsoluteMouseReportTypeId]; }
...
///        error messages.
///
#define PAPILIO_ASSERT_CONDITION(SIMULATOR, ...)                                       \
