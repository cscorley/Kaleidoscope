...
#define PAPILIO_AUTO_DEFINE_ACTION_INVENTORY_(WRAPPER, TYPENAME_KEYWORD)       \
                                                                               \
   private:                                                                    \
...
#define PAPILIO_AUTO_DEFINE_ACTION_INVENTORY(WRAPPER)                          \
   PAPILIO_AUTO_DEFINE_ACTION_INVENTORY_(WRAPPER,)

#define PAPILIO_AUTO_DEFINE_ACTION_INVENTORY_TMPL(WRAPPER)                     \
   PAPILIO_AUTO_DEFINE_ACTION_INVENTORY_(WRAPPER, typename)

#define PAPILIO_ACTION_STD_CONSTRUCTOR(WRAPPER, ...)                           \
      WRAPPER()                                                                \
